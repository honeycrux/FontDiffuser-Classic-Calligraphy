        ...
        loss = diff_loss + \
                args.perceptual_coefficient * percep_loss + \
                    args.offset_coefficient * offset_loss + \
                        args.style_rec_coefficient * style_reconstruction_loss
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, samples in enumerate(train_dataloader):
            ...
            if is_checkpoint_step and is_on_main_process:
                ...
                torch.save(get_submodel(model, "style_reconstructor").state_dict(), f"{save_dir}/style_reconstructor.pth")
                torch.save({
            ...
            if is_validation_step:
                ...
                val_progress_bar = tqdm(validation_dataloader, total=num_validation_steps, disable=not accelerator.is_local_main_process, desc="Validation", leave=False)
