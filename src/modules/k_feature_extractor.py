...
class KFeatureExtractor(nn.Module):
    def __init__(self, K):
        ...
        self.content_feature_extractor1 = unit_used(
            K=K, singleton_shape=content_feature_extractor_1_input_singleton
        )
        self.content_feature_extractor2 = unit_used(
            K=K, singleton_shape=content_feature_extractor_2_input_singleton
        )
        self.content_feature_extractor3 = unit_used(
            K=K, singleton_shape=content_feature_extractor_3_input_singleton
        )
        self.content_feature_extractor4 = unit_used(
            K=K, singleton_shape=content_feature_extractor_4_input_singleton
        )
        self.content_feature_extractor5 = unit_used(
            K=K, singleton_shape=content_feature_extractor_5_input_singleton
        )
...
if __name__ == "__main__":
    ...
    report_parameters_count(
        "ContentFeatureExtractor1", model.content_feature_extractor1
    )
    report_parameters_count(
        "ContentFeatureExtractor2", model.content_feature_extractor2
    )
    report_parameters_count(
        "ContentFeatureExtractor3", model.content_feature_extractor3
    )
    report_parameters_count(
        "ContentFeatureExtractor4", model.content_feature_extractor4
    )
    report_parameters_count(
        "ContentFeatureExtractor5", model.content_feature_extractor5
    )
