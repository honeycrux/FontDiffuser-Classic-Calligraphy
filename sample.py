...
def image_process_with_path(args) -> Union[None, tuple[Image.Image, Image.Image]]:
    ...
    assert isinstance(style_image, Image.Image), "The style image should be PIL.Image.Image."

    return content_image, style_image

def image_process_with_image(args, content_image, style_image) -> Union[None, tuple[Image.Image, Image.Image]]:
    content_character = args.content_character
...
def image_process(args, content_image=None, style_image=None) -> Union[None, tuple[torch.Tensor, torch.Tensor, Image.Image, Image.Image]]:
    ## Get PIL images
...
def sampling(args, pipe, content_image=None, style_image=None):
    ...
    image_process_output = image_process(args=args, content_image=content_image, style_image=style_image)
