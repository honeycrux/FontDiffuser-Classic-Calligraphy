...
>>>>>>> d686d6cfe37e1a8782d514c1812fca590bd6d6f7
...
<<<<<<< HEAD
        ...
        adjusted_style_features = self.attention_model(style_features)  # (batch_size, 1024, 3, 3)
=======
...
>>>>>>> d686d6cfe37e1a8782d514c1812fca590bd6d6f7
        ...
        for i, content_feature in enumerate(content_features):
            adjusted_content_feature = self.content_attention_models[i](content_feature)  # (batch_size, C, H, W)
